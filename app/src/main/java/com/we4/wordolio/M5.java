...
public class M5 extends AppCompatActivity {
    ...
    public void ok(View view)
    {
        try
        {
            ...
            {
                for(i=0;i<n;i++)
                    if(w.charAt(i)=='a' || w.charAt(i)=='l' || w.charAt(i)=='m' || w.charAt(i)=='o'||w.charAt(i)=='n'||w.charAt(i)=='d')
                        count=count+1;
                if(w.equals("almond") && count==6)
                {
                    score=score+100;
                    LocalDB.getInstance().insertToSimpleScore(10,score);
                    LocalDB.getInstance().updateSimpleScoreStatus(10,score);
                    AlertDialog.Builder ad = new AlertDialog.Builder(M5.this);
                    ...
                    ad
                            ...
                            .setPositiveButton("Continue",new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog,int id){
                                    Intent pos=new Intent(M5.this,Level.class);
                                    startActivity(pos);
                                    finish();
