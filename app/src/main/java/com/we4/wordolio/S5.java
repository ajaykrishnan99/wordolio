...
public class S5 extends AppCompatActivity {
    ...
    public void ok(View view)
    {
        try
        {
            ...
            {
                for(i=0;i<n;i++)
                    if(w.charAt(i)=='f' || w.charAt(i)=='u' || w.charAt(i)=='n' || w.charAt(i)=='k' || w.charAt(i)=='y')
                        count=count+1;
                if(w.equals("funky") && count==5)
                {
                    score=score+100;
                    LocalDB.getInstance().insertToSimpleScore(5,score);
                    LocalDB.getInstance().updateSimpleScoreStatus(5,score);
                    AlertDialog.Builder ad = new AlertDialog.Builder(S5.this);
                    ...
                    ad
                            ...
                            .setPositiveButton("Continue",new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog,int id){
                                    Intent pos=new Intent(S5.this,Level.class);
                                    startActivity(pos);
                                    finish();
